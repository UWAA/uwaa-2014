  ...
  <div class="row">
    ...
    <div class="col-md-12 uw-content" role='main'>
      ...
      <div class="uw-body-copy">
        ...
        <a href="<?php echo get_site_url('', '/spring-2021-star-awards')?>">See the Spring 2022 Star Awards</a></br>
        ...
        <div id="winner-cards">
          <div class="grid">
            <?php $UWAA->UI->makeStarAwardWinnerCards('fall2020'); ?>
          </div>
        </div>
    ...
    <div id="cards">
        <div class ="grid">
            ...
            <?php $UWAA->UI->makeStarAwardCards('fall2020'); ?>

...
use \UWAA\View\ThumbnailBrowser\Thumbnail\REJResources;  //resources archetype
use \UWAA\View\ThumbnailBrowser\Thumbnail\REJEvents;  //event archetype
use \UWAA\View\ThumbnailBrowser\Thumbnail\REJStories;  //story archetype
      ...
      <?php
       ...
       <h3>Programs and Events</h3>
            ...
            <div class="row">
                ...
                $thumbnailRowTwo->makeThumbnails(new REJEvents);
            ...
            <div class="row">
                ...
                $thumbnailRowThree->makeThumbnails(new REJResources);
            ...
            <div class="row">
                ...
                $thumbnailRowThree->makeThumbnails(new REJStories);

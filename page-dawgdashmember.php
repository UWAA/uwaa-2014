...
$rawParentQueryStringParams = strtoupper($_SERVER['QUERY_STRING']);
      ...
      if (strpos($rawParentQueryStringParams, "JOIN=TRUE&APPEALCODE=A19DDM&UTM_SOURCE=ANNOUNCEMENT&UTM_MEDIUM=EMAIL&UTM_CAMPAIGN=DAWG-DASH&M_HASH=QLWQ1TJNGBT4AZ18Q5QV3AYX9K23") === FALSE) {        
        header("Location: https://www.washington.edu/alumni/", FALSE, 301);
        die();        
      }

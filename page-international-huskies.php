...
wp_localize_script( 'mapbox', 'homeLink', 
  array( 
    'endpointURL' => apply_filters('remove_cms', home_url('/api/communities/geojson', 'https'))
  ) 
);
       ...
       ?>
         ...
         <div id="text-3" class="widget widget_text">
             ...
             <div class="textwidget">
                 Help keep our records current!  Please <a href="https://www.washington.edu/alumni/services/update/">update your contact information,</a> which helps ensure that you receive relevant communications from the UW and the UW Alumni Association.
             </div>
         </div>

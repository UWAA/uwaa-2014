...
class VirtualWarmupBenefitGrid extends ThumbnailBrowser implements Thumbnail
{
...
$template = <<<TEMPLATE
<div class="featured-post four-column col-xs-12 goodie-bag"><a href="{$this->postURL}"><div class="image-frame">$image$callout</div><div class="copy"><h6 class="subtitle">{$this->postSubtitle}</h6> <h4 class="title">{$this->postTitle}</h4> $date <p class="excerpt">{$this->postExcerpt}</p> <a class="link-arrow" href="$link"><span class="visually-hidden">Link</span></a></div></a></div>
TEMPLATE;
